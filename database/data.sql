...
INSERT INTO "posts" ("title", "calories", "body", "userId", "categoryId", "totalVotes", "views", "createdAt")
VALUES ('Jersey Mike''s Turkey Provolone Tub', 550, 'Order Mike''s Way, no olive oil or mayo. Red wine vinegar is ok.', 2, 2, 12, 24, now());

INSERT INTO "posts" ("title", "calories", "body", "userId", "categoryId", "totalVotes", "views", "createdAt")
VALUES ('Sugar Free Cheesecake Pudding', 400, 'Sugar free jello cheesecake pudding. 1 cup Fairlife 0% fat milk, 2/3 cup nonfat Greek yogurt. Sugar free Reddi-wip.', 3, 3, 48, 24, now());
